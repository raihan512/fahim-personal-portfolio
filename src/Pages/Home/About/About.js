          ...
          <d iv className="md:w-6/12">
            <Fade left>
              <p className="mb-2 text-sm text-justify	text-[#6C757D]">
                ...
                an early age, I was always curious and interested in
                understanding how businesses work and the marketing they do to
                attract customers. Visiting public places, like stores and
                restaurants, I'd try to understand their business policies and
                the strengths and flaws and possible changes to be made. I have,
                therefore, grabbed any and every opportunity that was put in
                front of me to be able to actively observe and participate. As a
                result, I started experimenting, along with my friends, on many
                projects, some successful and some, not so much, as a
                high-school student.
              </p>
            </Fade>
            <Fade left>
              <p className="mb-2 text-sm text-justify	text-[#6C757D]">
                ...
                various organizations in Bangladesh and Canada. I founded a
                travel agency and learned how to run and grow a business. I also
                founded a charitable organization, understanding how serving the
                community and bringing smiles to people's faces, and receiving
                blessings can be so much more rewarding and fulfilling than
                money.{" "}
              </p>
            </Fade>
            <Fade left>
              <p className="mb-2 text-sm text-justify	text-[#6C757D]">
                Through all of my professional and entrepreneurial endeavors,
                I've developed multiple skillsets and the confidence to take on
                any challenges put forth to me. I am mindful of client needs and
            ...
            <Fade left>
              <p className="mb-2 text-sm text-justify	text-[#6C757D]">
                I believe that I still have a long way to go and much to learn.
                As such, I'm keeping my job preferences open to marketing, event
                ...
                professional environment is to work within a team. And
                possessing extreme curiosity and a joyful personality, I believe
                that I can also add to the team and boost workplace morale.{" "}
              </p>
            </Fade>
            <Fade left>
              <p className="mb-2 text-sm text-justify	text-[#6C757D]">
                Please feel free to reach out to me regarding any further
                queries.
              </p>
            </Fade>
            <Fade left>
